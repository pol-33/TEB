...
int fastq_parser(const string& input_file, const string& output_file = "", const int qmin = 0, bool per_seq_stats = false, bool low_mem = false, size_t stream_buf = 3UL * 1024UL * 1024UL);
